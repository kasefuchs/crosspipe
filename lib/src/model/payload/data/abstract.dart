...
abstract class AbstractPayloadData {
  static Map<PayloadType, AbstractPayloadData Function(Map<String, dynamic>)>
      _payloadDataFactories = {
  ...
  factory AbstractPayloadData.fromJson(
    ...
    AbstractPayloadData Function(Map<String, dynamic>)? payloadDataFactory =
        _payloadDataFactories[type];
