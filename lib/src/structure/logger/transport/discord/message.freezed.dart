...
mixin _$Message {
  ...
  List<Embed>? get embeds => throw _privateConstructorUsedError;
...
class _$_Message implements _Message {
  ...
  @override
  String toString() {
    return 'Message(avatarUrl: $avatarUrl, content: $content, username: $username, embeds: $embeds)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, avatarUrl, content, username,
...
abstract class _Message implements Message {
  const factory _Message(
      ...
      final String? content,
      final String? username,
      final List<Embed>? embeds}) = _$_Message;
