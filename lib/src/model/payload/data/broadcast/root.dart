...
class BroadcastRootPayload
    with _$BroadcastRootPayload
  ...
  factory BroadcastRootPayload.fromJson(Map<String, dynamic> json) {
    BroadcastType payloadType =
        $enumDecode(_$BroadcastTypeEnumMap, json['type']);
    AbstractBroadcastPayloadData payloadData =
        AbstractBroadcastPayloadData.fromJson(json['data'], payloadType);
